...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO userr (email, password) VALUES ('$email', '$password')";
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_query = "DELETE FROM userr WHERE id = '$delete_id'";
    mysqli_query($conn, $delete_query);
}

// Récupérer et afficher la liste des produits
$result = mysqli_query($conn, "SELECT * FROM userr");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
           ...
           <th>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<a href='edit_user.php?id={$row['id']}' class='btn btn-danger btn-sm'>Edit</a>";
                    echo "<a href='user.php?delete_id={$row['id']}' class='btn btn-danger btn-sm ml-1'>Delete</a>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
